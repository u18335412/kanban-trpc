        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className={`fixed inset-0 overflow-y-auto ${theme}`}>
            <div className="flex items-center justify-center min-h-full text-center dark:text-white">
              <TransitionChild>
                <Dialog.Panel className="w-full max-w-[30rem] p-8  text-left min-w-max align-middle transition-all dark:bg-dark-grey transform bg-white shadow-xl rounded-2xl">
                  <Dialog.Title
                    as="h3"
